...
const Icon = (props: SvgProps) => {
  return (
    <Svg width="22" height="23" viewBox="0 0 22 23" {...props}>
      <Defs>
        <ClipPath id="clip-Widi_-_Launch_Expand">
          <Rect width="22" height="23" />
        </ClipPath>
      </Defs>
      <G
        id="Widi_-_Launch_Expand"
        data-name="Widi - Launch / Expand"
        clipPath="url(#clip-Widi_-_Launch_Expand)">
        <G
          id="Group_6265"
          data-name="Group 6265"
          transform="translate(-67 -331.5)">
